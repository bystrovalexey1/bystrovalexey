...
def test_get_mask_card_number() -> None:
    """Проверка маскировки номера карты, где номер карты введен корректно"""
...
def test_get_mask_card_number_invalid(card_number: str, expected: str) -> None:
    """Проверка вывода "Некорректный ввод" при неправильном вводе карты"""
    assert get_mask_card_number(card_number) == expected


def test_get_mask_account() -> None:
    """Проверка маскировки номера счета, когда он введен корректно"""
...
def test_get_mask_account_invalid(account_number: str, expected: str) -> None:
    """Проверка вывода "Некорректный ввод" при неправильном вводе номера счета"""
